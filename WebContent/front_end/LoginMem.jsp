    ...
    <div class="modal-content" >
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="memLoginId" name="memLoginId" placeholder="Account" value="123123">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">密碼：</label>
			<input type="password" class="form-control" id="memLoginPsw" name="memLoginPsw" placeholder="Password" value="123123">
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-default" name="memLogin">登入</button>
