...
session.setAttribute("pageReq", "/front_end/ForgetPswFir.jsp");
%>
  ...
  <div class="modal-dialog modal-sm" role="document" >
    <div class="modal-content" >
      ...
      <div class="modal-header modal-header-info">
        ...
        <p class="modal-title" id="exampleModalLabel" >廠商忘記密碼</p>
      </div>
      <form METHOD="post" ACTION="<%=request.getContextPath()%>/front_end/fir_PC_Login.do">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-default" name="firLogin">送出</button>
