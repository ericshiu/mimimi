...
<title>產後廠商照片新增 - addPC.jsp</title>
</head>
<body>
...
<table border='2' cellpadding='5' cellspacing='0'>
	<tr align='center' valign='middle' height='20'>
		<th>廠商編號：</th>
		<td><%=request.getParameter("pc_no")%></td>
	</tr>
	<tr align='center' valign='middle' height='20'>
		<th>廠商名稱：</th>
		<td><%=request.getParameter("pc_name")%></td>
	</tr>	
</table>
<br>
...
<table border="0">
	...
	<tr>
		...
		<td><%=request.getParameter("pc_no")%></td>	</tr>
	<tr>
		<td>照片說明(20字):</td>
		<td><input type="TEXT" name="pcp_summary" size="50"	value="<%= (pcPictureVO==null)? "測試用" : pcPictureVO.getPcp_summary()%>" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td><img id="pcp_picture" src="" width=400px ></td>
	</tr>

</table>
<br>
<input type="hidden" name="pc_no" value="<%=request.getParameter("pc_no")%>">
