...
<h2>討論區檢舉：</h2>
	...
	<div id="exTab2" class="container" style="width:100%;">
		<ul class="nav nav-tabs">
			...
			<li id="li1"><a href="#1"  data-toggle="tab">審核通過</a></li>
			<li id="li2"><a href="#2"  data-toggle="tab">審核未通過</a></li>
		</ul>
		...
		<div class="tab-content ">
			...
			<%}else{ %>
				...
				<jsp:include page="/back_end/Report/Forum_Report_0.jsp" flush="true"/>
			<%} %>
			</div>
			<div class="tab-pane" id="1">
			<br>	
				<jsp:include page="/back_end/Report/Forum_Report_1.jsp" flush="true"/>
			</div>
			<div class="tab-pane" id="2">
			<br>
				<jsp:include page="/back_end/Report/Forum_Report_2.jsp" flush="true"/>
			</div>
		</div>
	</div>
	</div>
