...
List<PcReportVO> list =PCRSvc.getAllStatus("0");
...
<!-- 			int i 給序號使用 -->
			...
			<FORM METHOD="post" ACTION="man.do">
				    ...
				    <input type="hidden" name="pcr_no" value="${PCRVO.pcr_no}">
				    <input type="hidden" name="mem_no" value="${PCRVO.mem_no}">
				   <input type="hidden" name="pcr_pass"value="pass">
				    <input type="hidden" name="action"value="updatePCR">
				</FORM>
			</td>
			<td>
			<FORM METHOD="post" ACTION="man.do">
				    ...
				    <input type="hidden" name="pcr_no" value="${PCRVO.pcr_no}">
				    <input type="hidden" name="mem_no" value="${PCRVO.mem_no}">
				    <input type="hidden" name="pcr_pass"value="unpass">
				    <input type="hidden" name="action"value="updatePCR">
				</FORM>
...
<script>
$(function() {
	$(".btn-warning expend").click(function() {
