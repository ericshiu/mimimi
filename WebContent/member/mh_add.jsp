				...
				<div class="modal-body" >
					...
					<div class="form-group" >
						<div class="input-group" style=" width: 95%; margin: 10px;">
							...
							<input type="text" name="mh_weight" class="form-control" style="width:100%;">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
							<div class="input-group-addon" style="width: 85px;">收縮壓：</div>
							<input type="text" name="mh_ststolic" class="form-control" style="width:100%;">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
							<div class="input-group-addon" style="width: 85px;">舒張壓：</div>
							<input type="text" name="mh_diastolic" class="form-control" style="width:100%;">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
							<div class="input-group-addon" style="width: 85px;">心跳：</div>
							<input type="text" name="mh_heartbeat" class="form-control" style="width:100%;">
						...
						<div class="input-group" style="width: 95%; margin: 10px;">
								...
								<input type="text" name="mh_baby_heartbeat" class="form-control" style="width:100%;">
						...
						<td bgcolor="#CCCCFF">
						<input type="date" id="bookdate" name="mh_date">
						</td>
				 ...
				 <input
					type="hidden" name="mem_no" value="${userVO.mem_no}" />
...
function showvalue(){
	...
	$name('mh_ststolic')[0].value="80";
	$name('mh_diastolic')[0].value="120";
	$name('mh_heartbeat')[0].value="80";
	$name('mh_baby_heartbeat')[0].value="80";
