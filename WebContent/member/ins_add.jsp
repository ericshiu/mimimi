			...
			<div class="modal-content" >
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"
						style="text-align: center; font-weight: bold;color:#888;">產檢日期新增</h4>
				</div>
				...
				<FORM METHOD="post" ACTION="ins.do" name="form1">
					...
					<div class="form-group" >
						<div class="input-group" style="width: 95%; margin: 10px;"">
							...
							<input type="text" name="ins_hospital" class="form-control" style="width:100%;">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;"">
							<div class="input-group-addon" style="width: 85px;">預約診別：</div>
							<input type="text" name="ins_outoatuent" class="form-control" style="width:100%;">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;"">
							<div class="input-group-addon" style="width: 85px;">預約號碼：</div>
							<input type="text" name="ins_resetvation_no" class="form-control" style="width:100%;">

						</div>

						<div class="input-group" style="width: 95%; margin: 10px;">
						<div class="input-group-addon" style="width: 85px;">預約日期：</div>
				...
				<input
					type="hidden" name="mem_no" value="${userVO.mem_no}" /> <input
...
function showvalue(){
	...
	$name('ins_hospital')[0].value="聖安婦產科診所";
