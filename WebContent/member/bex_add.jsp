		...
		<div class="container">
			...
			<div class="modal-content" >
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"
						style="text-align: center; font-weight: bold;color:#888;">排泄紀錄</h4>
				</div>
			...
			<FORM METHOD="post" ACTION="bex.do" name="form1">
					...
					<!-- 					選寶寶 -->
						...
						<td bgcolor="#CCCCFF">
							<input input id="time"  type="datetime-local"  name="" style="height: 28px"; >
						</td>

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
						<div class="input-group-addon" style="width: 85px; height: 302px;">詳細記錄：</div>
						<TEXTAREA  type="TEXT" ROWS=3 COLS=30  name="bex_details" style="width: 100%; height: 302px;"> </TEXTAREA>
						</div>
...
function showvalue(){
	...
	$name('bex_details')[0].value="顏色正常、稀狀";
