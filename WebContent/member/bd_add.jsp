...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/member/js/calendar.css">
	...
	<jsp:include page="/front_end/frontTOP.jsp" flush="true" />
		...
		<div class="modal-dialog" role="document" style="width: 600px;">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"
						style="text-align: center; font-weight: bold; color: #888;">寶寶資料新增</h4>
				</div>
			...
			<div class="form-group">
					...
					%>
						<td bgcolor="#CCCCFF">
						<input type="date" id="bookdate" name="bd_birthday" value="<%=date_SQL %>">
						</td>
					</div>
					...
					<div class="input-group" style="width: 95%; margin: 10px;">
						...
						<td bgcolor="#CCCCFF">
						<input type="date" id="bookdate" name="bd_pre" value="<%=date_SQL %>">
						</td>
					</div>
...
function showvalue(){
	...
	$name('bd_name')[0].value="金貝貝";
	$name('bd_pre')[0].value="2018-02-01";
	$name('bd_birthday')[0].value="2018-02-01";
