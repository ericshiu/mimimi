...
<FORM METHOD="post" ACTION="be.do" name="form1">
					<div class="form-group" >
						...
						<td bgcolor="#CCCCFF">
							<input input id="time"  type="datetime-local"  style="height: 28px"; value="${babyEatingVO.be_date}">
						</td>

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
							<div class="input-group-addon" style="width: 85px;">進食類別紀錄：</div>
							<TEXTAREA name="be_sort" ROWS=3 COLS=30 value="${babyEatingVO.be_sort}"> </TEXTAREA>
						</div>
						
						<div class="input-group" style="width: 95%; margin: 10px;">
						<div class="input-group-addon" style="width: 85px;">奶量(c.c)：</div>
						<input type="number" name="be_mete" min="1" max="2000"  value="${babyEatingVO.be_mete}">
				...
				<input  name="be_no" style="display:none;"  value="${babyEatingVO.be_no}">	
...
// 	$id('time')value="2017/06/09";
	$name('be_sort')[0].value="美強生奶粉";
	$name('be_mete')[0].value="100";
