...
<%
	...
	String pc_no=(String)request.getAttribute("pc_no");
	...
	if (userType != null){
		...
		session.setAttribute("pageReq", "/member/EvaluationPC.jsp");////這行是在存重導路徑，所以要打本頁的網址
%>
<!DOCTYPE html>
<html lang="">
<head>
		...
		<div class="container">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="input-group" style="width: 95%;">
							...
							<textarea class="form-control" rows="5" name="fe_content"
								style="resize: vertical;"><%=(firmEvaluationVO == null) ? "" : firmEvaluationVO.getFe_content()%></textarea>
						</div>
					...
					<input type="hidden" name="fp_no" value="<%=pc_no%>">
