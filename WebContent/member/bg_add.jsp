			...
			<div class="modal-content" >
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"
						style="text-align: center; font-weight: bold;color:#888;">寶寶生長紀錄新增</h4>
				</div>
	...
	<FORM METHOD="post" ACTION="bg.do" name="form1">
					<div class="form-group" >
						...
						<div class="input-group" style="width: 95%; margin: 10px;">
							...
							<input type="text" class="form-control" style="width:100%;" name="bg_height">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
							<div class="input-group-addon" style="width: 85px;">體重：</div>
							<input type="text" class="form-control" style="width:100%;" name="bg_weight">

						</div>
						<div class="input-group" style="width: 95%; margin: 10px;">
							<div class="input-group-addon" style="width: 85px;">頭圍：</div>
							<input type="text" class="form-control" style="width:100%;" name="bg_head">
						...
						<td bgcolor="#CCCCFF">
							<input type="date" id="bookdate" name="bg_date">
						</td>
...
function showvalue(){
	...
	$name('bg_height')[0].value="70";
	$name('bg_weight')[0].value="7";
	$name('bg_head')[0].value="50";
	$id('bookdate').value="2017-05-01";
