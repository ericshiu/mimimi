...
<%	List<BabyDataVO> list2 = (List<BabyDataVO>) request.getAttribute("lisBE_ByCompositeQuery"); 
			...
			<div class="container">
				<div class="row">
					...
					<div class="title-word">不要讓孩子像大人一樣吃東西。</div>
					  ...
					  <div class="title-word">1歲到2歲的寶寶將陸續長出十幾顆牙齒，主要食物也逐漸從以奶類為主轉向以混合食物為主，而此時寶寶的消化系統尚未成熟，因此還不能給寶寶吃大人的食物，要根據寶寶的生理特點和營養需求，為他製作可口的食物，保證獲得均衡營養。</div>
					</div>
					</div>
				    ...
				    <table cellpadding="0" cellspacing="0" border="0">
				      ...
				      <c:forEach var="babyEatingVO" items="${list2}">
