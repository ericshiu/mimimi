...
//	alert(event.currentTarget.id);   //重要的一行
...
//	Inputmodify.type = 'hidden';
//	Inputmodify.name=inputname;
//	Inputmodify.value= this.value;
//	var modifyValue=document.getElementsByName(inputname)[0];
//	modifyValue.value=this.value;
//	form1.replaceChild(modifyValue1,modifyValue);
//	alert("最終="+modifyValue1.value);
	var inputname=event.currentTarget.id;
	var modifyValue=document.getElementsByName(inputname)[0];
	modifyValue.value=this.value;
}
